...
from part2 import get_number_of_zeros_part_2, get_new_number_part_2, create_numbers_list
...
def test_get_82_from_L68_part_2_zero_count():
    ...
    current_number = 50
    numbers = create_numbers_list()
    new_number, zero_count = get_new_number_part_2(numbers, current_number, text_input)
    assert new_number == 82
    assert zero_count == 1
